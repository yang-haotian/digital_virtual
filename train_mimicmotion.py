# -*- coding: utf-8 -*-
"""
CUDA_VISIBLE_DEVICES=0 accelerate launch train_mimicmotion.py \
    --pretrained_model_name_or_path=checkpoints/stable-video-diffusion-img2vid-xt-1-1 \
    --pretrain_unet outputs/MimicMotion-20240912012841/checkpoint-15000/unet.pth \
    --pretrain_cond_net outputs/MimicMotion-20240912012841/checkpoint-15000/cond_net_openpose.pth \
...
def main():
    ...
    if args.pretrain_unet:
        unet.load_state_dict(torch.load(args.pretrain_unet, weights_only=True), strict=True)
    # pose_net
