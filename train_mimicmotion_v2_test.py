...
CUDA_VISIBLE_DEVICES=0 accelerate launch train_mimicmotion_v2.py \
    ...
    --pretrain_unet outputs/MimicMotion-20240911160402/checkpoint-12000/unet.pth \
    --pretrain_cond_net outputs/MimicMotion-20240911160402/checkpoint-12000/cond_net_openpose.pth \
