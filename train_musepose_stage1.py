"""
CUDA_VISIBLE_DEVICES=1 accelerate launch train_musepose_stage1.py \
--config configs/train/musepose_train_stage1.yaml
"""
import os
...
def log_validation(
    ...
    with torch.autocast(
        ...
        val_infos = {
            ...
            "data/yht_tests/demo11": ["onanav2.png", "throw-pose.mp4", 70],
...
def main(cfg):
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset, batch_size=cfg.data.train_bs, shuffle=True, num_workers=cfg.data.train_bs, drop_last=False
    )
