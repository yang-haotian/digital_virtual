...
class EngineBuilder:
    ...
    def __init__(self, verbose=False):
        ...
        # image encoder
        # profile.set_shape("img", min=[1, 3, 224, 224], opt=[2, 3, 224, 224], max=[4, 3, 224, 224])
        # # # vae encoder
        # profile.set_shape("sample", min=[1, 3, 768, 512], opt=[2, 3, 768, 512], max=[4, 3, 768, 512])
        # # # vae decoder
        # profile.set_shape("latent_sample", min=[1, 4, 96, 64], opt=[8, 4, 96, 64], max=[16, 4, 96, 64])
...
if __name__ == "__main__":
    ...
    if args.engine is None:
        args.engine = args.onnx.replace(".onnx", f".trt")
    main(args)
